...
@Service("peninsula")
public class NttdataMensajeriaManagementPeninsulaImpl implements NttdataMensajeriaManagementServiceI {
	...
	public void addPedido(NttdataPedido pedido, List<NttdataProducto> productos) {
		...
		for (NttdataProducto producto : productos) {
			producto.setPrecio_pvp(producto.getPrecio_base() + (producto.getPrecio_base() * 0.21));
